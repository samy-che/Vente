...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        //Produit produit1 = new Produit("Apple iPhone 11 ", 500.0f, "Apple iPhone 14 32GB - Black", 10, "https://boulanger.scene7.com/is/image/Boulanger/0194253408253_h_f_l_0?wid=720&hei=720&resMode=sharp2&op_usm=1.75,0.3,2,0");
